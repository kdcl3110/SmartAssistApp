...
export default {
  ...
  checkboxBgColor: '#22C989',
  checkboxSize: 20,
  checkboxTickColor: '#fff',

  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#6A4E77' : '#6A4E77',
  brandInfo: '#23ffb8',
  brandSuccess: '#5cb85c',
  brandDanger: '#de5b49',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#22C989',
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#737373' : '#bfc6ea',
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? '#22C989' : '#fff',
  sTabBarActiveTextColor: '#22C989',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#22C989' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#22C989',
  ...
  toolbarBtnTextColor: platform === PLATFORM.IOS ? '#22C989' : '#fff',
  ...
  listNoteSize: 13,
  listItemSelected: platform === PLATFORM.IOS ? '#22C989' : '#188c5f',
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#F8F8F8' : '#188c5f',
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#22C989' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#22C989' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#188c5f',
  segmentBorderColor: platform === PLATFORM.IOS ? '#22C989' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : '#188c5f',
  ...
  // Tab
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#188c5f',
  topTabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#b3c7f9',
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#22C989' : '#fff',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#fff',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? '#22C989' : '#fff',
